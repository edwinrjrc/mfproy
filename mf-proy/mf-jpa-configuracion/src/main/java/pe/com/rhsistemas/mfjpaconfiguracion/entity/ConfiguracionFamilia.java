...
public class ConfiguracionFamilia implements Serializable {
	...
	@Column(name="tx_dias_coci")
	private String diasCocina;
	...
	/**
	 * @return the diasCocina
	 */
	public String getDiasCocina() {
		return diasCocina;
	}

	/**
	 * @param diasCocina the diasCocina to set
	 */
	public void setDiasCocina(String diasCocina) {
		this.diasCocina = diasCocina;
	}
