...
public interface PlatoIngredienteRepository extends JpaRepository<PlatoIngrediente, PlatoIngredientePK> {
	...
	@Query(value = "select pi2.id.idIngrediente as idIngrediente, i.deIngrediente as deIngrediente, SUM(case when pi2.nuCantidad is null then 0 else pi2.nuCantidad end) as totalIngrediente, um.idUnidMedi as idUnidadMedida, um.deUnidMedi as deUnidadMedida"
